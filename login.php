...
<div class="section">
  <div class="main">
    ...
    <div class="log-email">
        ...
        <div  id="username" class="input-mail">
          <div class="la la-envelope input-icon"></div>
        <input  type="text" name="user" placeholder="Email or User Name" autocomplete="off">
       </div>
      </div>
      <div class="log-pass">
      <label class="label-text">
      ...
      <div  id="password" class="input-pass">
    ...
    <?php
          $admins = $conn->query("SELECT admin_name FROM admins")->fetchAll(PDO::FETCH_COLUMN);
          $normaluser = $conn->query("SELECT 	user_fullname FROM register")->fetchAll(PDO::FETCH_COLUMN);
          if( $_SERVER['REQUEST_METHOD'] == "POST"){
              if (empty($_POST['user']) || empty($_POST['pass'])){
                  echo "<script>alert('Please Enter User Name And Password');
                  ...
                  else if( in_array($_POST['user'],$normaluser)){
                    $_SESSION['user'] = $_POST['user'];
                    $_SESSION['pass'] = $_POST['pass'];
